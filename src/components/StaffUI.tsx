              ...
              <div className="mb-6">
                ...
                <div className="flex gap-2">
                  ...
                  <button
                    ...
                    className="px-4 py-3 bg-gradient-to-r from-[#E6A85C] to-[#E85A9B] text-white rounded-xl hover:shadow-lg transition-all duration-200 flex items-center gap-2 shrink-0"
              ...
              <div className="mb-6">
                ...
                <div className="flex gap-2">
                  ...
                  <button
                    ...
                    className="px-4 py-3 bg-gradient-to-r from-green-500 to-emerald-600 text-white rounded-xl hover:shadow-lg transition-all duration-200 flex items-center gap-2 shrink-0"
